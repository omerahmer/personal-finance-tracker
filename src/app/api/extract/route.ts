...
- date: string
- expenseType: "shopping" | "food" | "groceries" | "subscriptions" | "bills" | "services" | "payments"
- vendor: string
- price: string
- location: string
...
export async function POST(request: Request) {
    ...
    for (const document of textractResponse.ExpenseDocuments) {
    ...
    const formattedExpenses: FormattedExpense[] =
